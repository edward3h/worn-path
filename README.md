...
[![CurseForge Downloads](https://cf.way2muchnoise.eu/full_1465038_downloads.svg?badge_style=flat)](https://www.curseforge.com/minecraft/mc-mods/worn-path)
[![CurseForge Versions](https://cf.way2muchnoise.eu/versions/1465038.svg?badge_style=flat)](https://www.curseforge.com/minecraft/mc-mods/worn-path)

An Architectury-based Minecraft mod for Fabric and NeoForge (MC 1.21.11).
...
1. Install [Fabric Loader](https://fabricmc.net/) (0.18.4+) or
   [NeoForge](https://neoforged.net/) (21.11+) for Minecraft 1.21.11.
